...
public class Utils {
    ...
    public static File getKurarDirectory() {
        return new File(getWorkingDirectory(), "KurarClient");
    }
    ...
    public static boolean checkUpdate() {
        try {
            String version = readURL();
            File file = new File(getKurarDirectory(), "latest.json");
            if (!file.exists())
                return true;
            return !Objects.equals(Json.parse(new InputStreamReader(new FileInputStream(file))).asObject().getString("version", ""), version);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static String readURL() throws Exception {
        ...
        try {
            URL url = new URL("https://palpunte-union.github.io/KurarClient/client/latest.json");
            ...
            return Json.parse(builder.toString()).asObject().getString("version", "");
        } catch (Exception e) {
            URL url = new URL("https://palpunte-union.github.io/KurarClient/client/latest.json");
            reader = new BufferedReader(new InputStreamReader(url.openStream()));
            StringBuilder builder = new StringBuilder();
    ...
    public void downloadVersionJson() throws Exception {
        ...
        try {
            ...
            URL url = new URL("https://palpunte-union.github.io/KurarClient/client/" + readURL() + "/KurarClient.json");
            byteChannel = Channels.newChannel(url.openStream());
    ...
    public static boolean checkLauncherUpdate() {
        try {
            return !readURL("https://palpunte-union.github.io/KurarClient/launcher/version.json").equals(Main.LAUNCHER_VERSION);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
